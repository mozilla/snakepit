...
# cuda-11-2 doesn't install everything (missing cuda-runtime-11-2 and cuda-demo-suite-11-2), try just cuda
aptget install nvidia-driver-460 nvidia-utils-460 nvidia-cuda-toolkit cuda cuda-drivers-460
